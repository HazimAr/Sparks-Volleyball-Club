        ...
        <div className='register-outside-div'>
            <div className='register-inside-div' id='register'>
                <div className='register-text-div' id='register-text'>
                    ...
                    <Link href='/register'>
                        <a>
                            <button id='register-button' className='intro-button'>Register Now</button>
                        </a>
                    </Link>
                </div>
                <Image width={700} height={400.666666} id='register-img' className="register-img" src='/Images/Sparks/TourneyImage.jpg' alt="" />
            </div>
        </div>
    )
}
