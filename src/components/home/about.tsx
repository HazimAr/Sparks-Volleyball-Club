...
export default function About(): JSX.Element {
    ...
    function AboutRow(props: any) {
        return (
            <div style={{ flexDirection: props.flex }} className='about-row'>
                <Image width={600} height={400} className='about-team-logo' id={props.imageID} src={props.image} alt='' />
                {props.func}
            </div>
        )
    }
    return (
        <div className='about-div' id='about'>
            ...
            <AboutRow func={
                <AboutSection image='/Images/desktop.svg' title='Who We Are' id='row-0'
                ...
                />}
                image='/Images/Sparks/8-22-2_Tourney-55c.jpg' imageID='about-img-1' flex='row-reverse' />
            <AboutRow func={
                <AboutSection image='/Images/mobile.svg' title='What We Do' id='row-1'
                ...
                />}
                image='/Images/Sparks/8-22-2_Tourney-43.jpg' imageID='about-img-2' flex='row' />
        </div>
    )
}
