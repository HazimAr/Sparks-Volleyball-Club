  ...
  return (
    <Container>
      <ContainerInside>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Sparks Volleyball Club LLC, 3778 W
              Cheyenne Ave #120, North Las Vegas, NV 89032.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Sparks Volleyball Club,
              accessible from{" "}
              <a
                href="https://sparksvolleyballclub.com"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://sparksvolleyballclub.com
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            <p>By email: info@sparksvolleyballclub.com</p>
          </li>
          <li>
            <p>
              By visiting this page on our website:{" "}
              <a
                href="https://sparksvolleyballclub.com/privacy"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://sparksvolleyballclub.com/privacy
              </a>
            </p>
          </li>
          <li>
            <p>By phone number: (702) 502-9462</p>
          </li>
          <li>
            <p>By mail: 3778 W Cheyenne Ave #120, North Las Vegas, NV 89032</p>
          </li>
        </ul>
      </ContainerInside>
    </Container>
